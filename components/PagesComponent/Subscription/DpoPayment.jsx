...
import dpoPay from "../../../public/assets/dpoPay.webp";
...
const DpoPayment = ({ selectedPackage }) => {
    ...
    return (
        <button onClick={handleDpoPayment} className="w-full p-2">
            <div className="flex items-center gap-2 justify-between ">
                <div className="flex gap-3 items-center">
                    ...
                    <p className="text-lg font-semibold">{t("dpoPay")}</p>
                </div>
                <div>
                    {isLoading ? (
